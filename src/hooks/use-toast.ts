...
function toast(props: Toast | string, options?: Partial<Omit<Toast, "title">>) {
  const id = genId()
  
  // Support both function calling patterns
  ...
  const duration = toastProps.duration || TOAST_REMOVE_DELAY;
